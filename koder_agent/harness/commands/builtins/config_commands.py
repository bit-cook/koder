"""Config-related command descriptors."""
...
CONFIG_COMMAND_SPECS = {
    ...
    "output-style": {"help_text": "Inspect and update terminal output styling"},
    "permissions": {"help_text": "Inspect runtime permission behavior"},
}
